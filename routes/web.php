    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::middleware('Rol:SuperAdministrador')->group(function () {
            ...
            Route::resource('usuariosAdmins', AdminUserController::class);
            Route::get('/usuariosAdmins/eliminados', [AdminUserController::class, 'Eliminados'])->name('usuariosAdmins.eliminados');
            Route::put('/usuariosAdmins/cambiarEstado/{users}/{estado}', [AdminUserController::class, 'cambiarEstado'])->name('usuariosAdmins.cambiarEstado');
            Route::put('/usuariosAdmins/{id}/actualizar-estado', [AdminUserController::class, 'actualizarEstado'])->name('usuariosAdmins.actualizarEstado');
