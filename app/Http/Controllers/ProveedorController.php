...
class ProveedorController extends Controller
{
    ...
    {
        $prove = Proveedor::with(['profesiones', 'tipo_documentos'])
            // ->where('rol_id', '4')
            ->get();
    ...
    {
        $Profesiones = Profesion::all(); // Asegúrate de que el modelo Paises exista
        $Tipo_documentos = tipo_documentos::all(); // Asegúrate de que el modelo Departamentos exista

        return view('proveedores.editar', compact('prove', 'Profesiones', 'Tipo_documentos'));
        //
    }
