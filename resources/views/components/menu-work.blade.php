 <aside class="sidebar" role="navigation" aria-label="Menú principal">
     ...
     <a href="{{ route('solicitudes.estado') }}" class="menu-item" tabindex="0" role="link"
 ...
 <x-menu-nav>
     <li><a href="{{ route('trabajador.index') }}"><i class="bi bi-house-door icon-lg" aria-hidden="true"></i>
             Inicio</a></li>
     <li><a href="/usuario/inicio.html"><i class="bi bi-person-circle" aria-hidden="true"></i> Perfil</a></li>
     <li><a href="/usuario/Menuu/Servicios.html"><i class="bi bi-briefcase icon-lg" aria-hidden="true"></i>
             Servicios</a></li>
     <li><a href="/usuario/Menuu/Contacto.html"><i class="bi bi-telephone icon-lg" aria-hidden="true"></i> Contacto</a>
     </li>
     <li><a href="/usuario/Menuu/Acercade.html"><i class="bi bi-info-circle icon-lg" aria-hidden="true"></i> Acerca
             de</a></li>
 </x-menu-nav>
