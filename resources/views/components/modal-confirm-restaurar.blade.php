...
<div class="modal fade" id="confirmRestaurarModal-{{ $id }}" tabindex="-1"
    aria-labelledby="confirmRestaurarModalLabel-{{ $id }}" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmRestaurarModalLabel-{{ $id }}">Confirmar</h5>
