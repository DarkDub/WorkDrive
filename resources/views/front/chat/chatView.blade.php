...
<body class="from-gray-50 via-white to-gray-100 text-gray-800">
    ...
    <div class="flex h-screen max-w-6xl w-full mx-auto border border-gray-200 rounded-2xl overflow-hidden mt-8"
        id="content">
