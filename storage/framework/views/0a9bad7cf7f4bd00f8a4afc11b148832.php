...
<head>
    ...
    <script defer src="<?php echo e(asset('js/client-js/login.js')); ?>"></script>
</head>
        ...
        <div class="login-container">
            <div class="header-login">
                ...
                <p class="text-muted mb-3">
                    No tiene cuenta? <a href="<?php echo e(route('registro')); ?>" class="text-success fw-semibold">Crear</a>
                </p>
            </div>
...
<?php /**PATH C:\Users\Palma\Desktop\WorkDrive-Sena\resources\views/auth/login.blade.php ENDPATH**/ ?>