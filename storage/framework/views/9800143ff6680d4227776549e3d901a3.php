                    ...
                    <tbody> 
                        <?php $__currentLoopData = $rol; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($r->rolPadre ? $r->rolPadre->nombre : 'sin padre'); ?></td>
                                <td>
                                    
                                    <button class="btn btn-danger btn-sm"
                                        data-bs-target="#confirmRestaurarModal-<?php echo e($r->id); ?>"
...
<?php $component = App\View\Components\ModalConfirmRestaurar::resolve(['id' => $r->id,'route' => route('rol.estado', [$r->id, 'A'])] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($r->nombre),'mensaje' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('restaurar'),'tipo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('el Rol:.... ')]); ?>
...
<?php /**PATH C:\Users\Palma\Desktop\NewProject\WorkDrive-Sena (1)\WorkDrive-Sena\resources\views/roles/rolesEliminados.blade.php ENDPATH**/ ?>