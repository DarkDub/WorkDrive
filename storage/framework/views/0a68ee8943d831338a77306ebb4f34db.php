...
<div class="modal fade" id="confirmDeleteModal-<?php echo e($id); ?>" tabindex="-1"
    aria-labelledby="confirmDeleteModalLabel-<?php echo e($id); ?>" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmDeleteModalLabel-<?php echo e($id); ?>">Confirmar</h5>
...
<?php /**PATH C:\Users\Palma\Desktop\NewProject\WorkDrive-Sena (1)\WorkDrive-Sena\resources\views/components/modal-confirm-delete.blade.php ENDPATH**/ ?>