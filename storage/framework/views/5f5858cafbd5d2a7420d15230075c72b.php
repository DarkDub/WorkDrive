                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('permisos.update', $permiso->id)); ?>" method="POST">
                        ...
                        <?php echo method_field('PUT'); ?>
                         ...
                         <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo e(old('nombre', $permiso->nombre)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion"><?php echo e($permiso['descripcion']); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="footer d-flex pt-2 w-100 mt-3">
                            ...
                            <a href="<?php echo e(route('permisos.index')); ?>" class="btn btn-danger mx-3">Cancelar</a>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\workdrive\WorkDrive-Sena\resources\views/permisos/editar.blade.php ENDPATH**/ ?>