...
<?php $component->withAttributes([]); ?>
    <div class="content-create-prove">
        ...
        <form action="<?php echo e(route('clientes.store')); ?>" method="POST" class="form-create-prove">
            <?php echo csrf_field(); ?>
            <div class="row">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="codP" name="codigo_postal" class="form-control" value="<?php echo e(old('codigo_postal')); ?>"
                        required>
                    <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php endif; ?>
<?php /**PATH C:\Users\Palma\Desktop\NewProject\WorkDrive-Sena (1)\WorkDrive-Sena\resources\views/clientes/create.blade.php ENDPATH**/ ?>