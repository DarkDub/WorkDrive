...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/prove.css')); ?>">
</head>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column px-2 mt-3 w-100">
            ...
            <li class="nav-item">
                <a href='<?php echo e(route('admin_user.index')); ?>' class="nav-link text-white d-flex align-items-center">
            ...
            <li class="nav-item">
                <a href='<?php echo e(route('prove.index')); ?>' class="nav-link text-white d-flex align-items-center">
    ...
    <div class="topbar d-flex align-items-center px-4">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="d-flex align-items-center">
                ...
                <span class="fs-5 me-5"><?php echo e(Auth::user()->name); ?></span>
...
<?php /**PATH C:\xampp\htdocs\workdrive\WorkDrive-Sena\resources\views/components/principal.blade.php ENDPATH**/ ?>