...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="nit" name="nit" class="form-control"
                        value="<?php echo e(old('nit', $cliente->nit)); ?>" required>
                    <?php $__errorArgs = ['nit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php endif; ?>
<?php /**PATH C:\Users\Palma\Desktop\NewProject\WorkDrive-Sena (1)\WorkDrive-Sena\resources\views/clientes/editar.blade.php ENDPATH**/ ?>